...
plt.savefig('./figure_and_SSA_VS_ISSA/F1_Sphere.png', dpi=300, bbox_inches='tight', pad_inches=0.5)
plt.close()
print("[✓] F1_Sphere.png")
...
plt.tight_layout(pad=2.0)
plt.savefig('./figure_and_SSA_VS_ISSA/F2_Schwefel222.png', dpi=300, bbox_inches='tight', pad_inches=0.5)
plt.close()
...
plt.tight_layout(pad=2.0)
plt.savefig('./figure_and_SSA_VS_ISSA/F3_Ackley.png', dpi=300, bbox_inches='tight', pad_inches=0.5)
plt.close()
print("[✓] F3_Ackley.png")
...
plt.tight_layout(pad=2.0)
plt.savefig('./figure_and_SSA_VS_ISSA/F4_Rastrigin.png', dpi=300, bbox_inches='tight', pad_inches=0.5)
plt.close()
